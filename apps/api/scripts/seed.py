...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://dcos:dcos@localhost:5432/dcos").replace(
...
ACS = [
    (1, "Narela", "NDE"), (2, "Burari", "NDE"), (3, "Timarpur", "NDE"),
    (4, "Adarsh Nagar", "NDE"), (5, "Badli", "NWD"), (6, "Rithala", "NWD"),
    (7, "Bawana", "NWD"), (8, "Mundka", "WD"), (9, "Kirari", "NWD"),
    (10, "Sultanpur Majra", "NWD"), (11, "Nangloi Jat", "WD"), (12, "Mangol Puri", "NWD"),
    (13, "Rohini", "NWD"), (14, "Shalimar Bagh", "NWD"), (15, "Shakur Basti", "NWD"),
    (16, "Tri Nagar", "NWD"), (17, "Wazirpur", "NDE"), (18, "Model Town", "NDE"),
    (19, "Sadar Bazar", "CD"), (20, "Chandni Chowk", "CD"), (21, "Matia Mahal", "CD"),
    (22, "Ballimaran", "CD"), (23, "Kasturba Nagar", "ED"), (24, "Gandhi Nagar", "ED"),
    (25, "Shahdara", "SHA"), (26, "Seemapuri", "NED"), (27, "Rohtas Nagar", "SHA"),
    (28, "Seelampur", "NED"), (29, "Ghonda", "NED"), (30, "Babarpur", "SHA"),
    (31, "Gokalpur", "NED"), (32, "Mustafabad", "NED"), (33, "Karawal Nagar", "NED"),
    (34, "Madipur", "WD"), (35, "Patparganj", "ED"), (36, "Laxmi Nagar", "ED"),
    (37, "Vishwas Nagar", "SHA"), (38, "Kondli", "ED"), (39, "Trilokpuri", "ED"),
    (40, "Dwarka", "SWD"), (41, "Matiala", "SWD"), (42, "Uttam Nagar", "WD"),
    (43, "Najafgarh", "SWD"), (44, "Bijwasan", "SWD"), (45, "Palam", "SWD"),
    (46, "Delhi Cantonment", "SWD"), (47, "Rajouri Garden", "WD"), (48, "Hari Nagar", "WD"),
    (49, "Tilak Nagar", "WD"), (50, "Janakpuri", "WD"), (51, "Vikaspuri", "WD"),
    (52, "Uttam Nagar", "WD"), (53, "Delhi Cantonment", "SWD"), (54, "New Delhi", "ND"),
    (55, "Kashmere Gate", "CD"), (56, "Moti Nagar", "WD"), (57, "Maliviya Nagar", "SD"),
    (58, "R.K. Puram", "SD"), (59, "Mehrauli", "SD"), (60, "Chhatarpur", "SD"),
    (61, "Deoli", "SD"), (62, "Ambedkar Nagar", "SD"), (63, "Sangam Vihar", "SD"),
    (64, "Greater Kailash", "SD"), (65, "Kalkaji", "SED"), (66, "Tughlakabad", "SED"),
    (67, "Badarpur", "SED"), (68, "Okhla", "SED"), (69, "Trilokpuri", "ED"),
    (70, "Kondli", "ED"),
]
...
CATEGORIES = {
    "MCD": ["Pothole / Road Damage", "Garbage Not Collected", "Stray Animal Menace",
             "Illegal Construction", "Waterlogging / Flooding", "Park Not Maintained",
             "Street Dog Menace", "Unauthorized Signboard"],
    "DJB": ["No Water Supply", "Low Water Pressure", "Sewage Overflow",
             "Pipe Leakage / Burst", "Blocked Drain", "Water Quality Issue",
             "New Connection Delay"],
    "PWD": ["Road Repair Required", "Flyover / Bridge Damage", "Footpath Broken",
             "Streetlight Not Working", "Divider Damaged", "Road Cutting Not Restored"],
    "DP":  ["Vehicle Theft", "Noise Pollution", "Traffic Signal Fault",
             "Illegal Parking", "Street Light Out", "Anti-social Activity"],
    "DTC": ["Bus Not Available on Route", "Bus Delay", "Overcrowded Bus",
             "Bus Stop Damaged", "Reckless Driving", "Wrong Route"],
    "BSES-R": ["Power Outage", "Low Voltage", "Meter Fault", "Billing Dispute",
                "Overhead Wire Hanging", "Transformer Fault"],
    "BSES-Y": ["Power Outage", "Low Voltage", "Meter Fault", "Billing Dispute",
                "Overhead Wire Hanging", "Frequent Tripping"],
    "TPDDL": ["Power Outage", "Low Voltage", "Meter Issue", "Street Light Fault",
               "Wire Down", "New Connection Delay"],
    "DPCC": ["Industrial Air Pollution", "Vehicle Emissions", "Construction Dust",
              "Illegal Burning / Biomass", "Noise From Factory", "Water Pollution"],
    "NDMC": ["Garbage Collection", "Park Maintenance", "Street Light", "Road Repair",
              "Drain Cleaning", "Public Toilet Condition"],
    "DMRC": ["Platform Overcrowding", "AC Not Working in Coach", "Lift / Escalator Fault",
              "Token Machine Issue", "Security Concern", "Cleanliness Issue"],
    "HEALTH": ["Medicine Not Available", "Doctor Absent", "Long Queue at Hospital",
                "Ambulance Delay", "Poor Sanitation at Hospital", "Equipment Not Working"],
}
...
LOCATION_HINTS = [
    "main market", "sector road", "near metro station", "residential colony",
    "near school", "main chowk", "colony gali no. 3", "park area",
    "near hospital", "market road", "DDA flats area", "B-block",
    "near railway crossing", "outer ring road", "inner lane", "service road",
    "near govt office", "housing society", "block C", "phase 2",
]
        ...
        async with conn.transaction():
            ...
            for name, code, district_code in ZONES:
                ...
                await conn.execute(
                    ...
                    zid, name, code, district_ids[district_code],
                )
            ...
            for number, name, district_code in ACS:
                await conn.execute(
                    ...
                    str(uuid.uuid4()), name, number, district_ids[district_code],
                )
            ...
            for ward_num in range(1, 273):
                ...
                await conn.execute(
                    ...
                    wid, ward_name, ward_num, zone_id, district_id, lat, lng,
                )
            ...
            for _dept_code, dept_id in dept_ids.items():
                for priority, (resolution_h, escalation_h) in sla_matrix.items():
                    await conn.execute(
                        ...
                        str(uuid.uuid4()), dept_id, priority, resolution_h, escalation_h,
                    )
                ...
                for i in range(3):
                    ...
                    await conn.execute(
                        """INSERT INTO officers (id, user_id, department_id, designation, employee_id)
                           VALUES ($1, $2, $3, $4, $5) ON CONFLICT DO NOTHING""",
                        oid, uid, dept_id,
                        f"Junior Engineer / Inspector ({dept_code})", emp_id,
                    )
            ...
            for i in range(50):
                ...
                await conn.execute(
                    """INSERT INTO users (id, name, phone, role, language_pref)
                       VALUES ($1, $2, $3, $4, $5) ON CONFLICT DO NOTHING""",
                    cuid, f"Citizen {i+1:03d}", f"+91987654{i:04d}", "citizen",
            ...
            for n in range(1, 521):
                ...
                await conn.execute(
                    ...
                    gid, tracking_id, citizen_id, channel, raw_text,
                    random.choice(["hi", "en", "hi", "en", "pa"]),
                    category, severity, dept_id, officer_id,
                    status, priority, ward_id, lat, lng,
                    sla_due, citizen_id is None, created_at, created_at, closed_at,
                ...
                transitions = {
                    ...
                    "ACTION_TAKEN": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "IN_PROGRESS", "ACTION_TAKEN"],
                    "RESOLVED": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "IN_PROGRESS", "ACTION_TAKEN", "RESOLVED"],
                    "VERIFIED": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "IN_PROGRESS", "ACTION_TAKEN", "RESOLVED", "VERIFIED"],
                    "CLOSED": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "IN_PROGRESS", "ACTION_TAKEN", "RESOLVED", "VERIFIED", "CLOSED"],
                    "ESCALATED": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "ESCALATED"],
                    "REOPENED": ["RECEIVED", "CLASSIFIED", "ASSIGNED", "IN_PROGRESS", "ACTION_TAKEN", "RESOLVED", "REOPENED"],
                ...
                for i, s in enumerate(chain):
                    ...
                    await conn.execute(
                        """INSERT INTO status_events (id, grievance_id, from_status, to_status, actor_id, ts)
                           VALUES ($1, $2, $3, $4, $5, $6)""",
                        str(uuid.uuid4()), gid, prev, s,
                        officer_id or "system", event_ts,
                    )
                    prev = s
            ...
            for n in range(521, 541):
                ...
                await conn.execute(
                    ...
                    "hi", "Pothole / Road Damage", random.randint(40, 90),
                    dept_id, "ASSIGNED", "HIGH", ward_id, lat, lng,
